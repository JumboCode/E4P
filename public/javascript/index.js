...
import $ from 'jquery';
import {generateUserHeader} from './header';
import {chatSetup, chatElements, createMessageDiv} from './chat';
...
function openChat() {
  ...
  open.empty();
  open.html([
    <div class='row'>Waiting to connect to an ear!</div>,
    <div class='row'>
...
$(() => {
  ...
  chatSetup(sendMessage, false, chat.userId, send_typing_message);
});
